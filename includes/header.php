        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto ">
                    ...
                    <li class="nav-item">
                        <!-- <a class="nav-link text-light font-weight-bold " href="#">CONTRIBUTORS</a> -->
                    </li>
                    <li class="nav-item"><a href="weather-by-city.php" class="nav-link text-light font-weight-bold">CITY WISE WEATHER</a></li>
                    <li class="nav-item">
